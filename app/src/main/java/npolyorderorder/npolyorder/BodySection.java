...
public class BodySection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpleSnackbar =(Button)findViewById(R.id.btnProceedtocheck);
        ...
        btnSimpleSnackbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(BodySection.this, "Successfully added in database...", Toast.LENGTH_SHORT).show();
                //final Dialog myDialog = new Dialog(BodySection.this);
                //myDialog.getWindow();
        ...
        l_row = (LinearLayout)findViewById(R.id.lout);
    ...
    private void addservices() {
        ...
        for (int ij = 0; ij < bean.size(); ij++) {
            ...
            LinearLayout lmain = new LinearLayout(BodySection.this);
            ...
            final ImageView image = new ImageView(BodySection.this);
            ...
            final TextView txt_name = new TextView(BodySection.this);
          ...
          /*  final TextView txt_name11 = new TextView(BodySection.this());
            ...
            final TextView txt_name1 = new TextView(BodySection.this);
           ...
           /* final TextView txt_prokg = new TextView(BodySection.this());
...
*/
          /* txt_prokg.setBackgroundResource(R.drawable.spborder);
           ...
           /* txt_prokg.setEllipsize(TextUtils.TruncateAt.END);
            ...
            final TextView txt_proprice = new TextView(BodySection.this);
          ...
          /*  final ImageView image1 = new ImageView(BodySection.this());
            ...
            final TextView txt_proquent = new TextView(BodySection.this);
            ...
            final ImageView image2 = new ImageView(BodySection.this);
            image2.setBackgroundResource(R.drawable.ic_left);
            image2.setLayoutParams(params6);


            final ImageView image4 = new ImageView(BodySection.this);
            ...
            final View txt_name2 = new View(BodySection.this);
